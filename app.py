...
with col_left:
    ...
    st.link_button("2.2. Рівні небезпечного впливу (AEGL) БОР та НХР", "https://sergsh1125-dotcom.github.io/toxicdoze/")
...
with col_right:
    ...
    st.link_button("3.3. Допустимий час опромінення", "https://sergsh1125-dotcom.github.io/calculator-time/")
